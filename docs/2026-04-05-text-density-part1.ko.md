...
![모델별 PER 비교](../outputs/step0_fig1_per_by_model.png)
...
![모델 간 상관 행렬](../outputs/step0_fig2_correlation_matrix.png)
...
![klue/bert-base 층별 신호](../outputs/step1_klue_bert_ko.png)
...
![Encoder vs Decoder 비교](../outputs/step1_paradigm_layer_delta.png)
...
![Surprisal 분석](../outputs/step1_surprisal_boxplot.png)
...
![검증 실험 비교](../outputs/step3_validation_comparison.png)
...
![PER-신호 상관](../outputs/step3_per_signal_correlation.png)
